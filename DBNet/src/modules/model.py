...
from .data_offload import DataProcess
...
class DBnet(nn.Cell):
    def __init__(self, config, isTrain=True):
        ...
        self.data_offload = config.dataset.offload
        self.data_preprocess = DataProcess(mean=config.dataset.mean, std=config.dataset.std)

    def construct(self, img):
        if self.data_offload:
